...
const ChannelPartnerForm = () => {
	...
	const handleSubmit = (event) => {
		...
		axios.post('https://app.noqu.in/api/channel-form', formData)
			.then((_response) => {
				navigate('/Submit');
		...
		<div className="CareerForm">
			<form onSubmit={handleSubmit} className="reg-form">
				<div className="reg-form-head">
					<h2>Partner Program Registration</h2>
				</div>
				...
				<div className='CareerForm_row'>
					...
					<div className="Select">
						<select name="typeOfCompany" value={typeOfCompany} onChange={(event) => setTypeOfCompany(event.target.value)} required>
				...
				<div className='CareerForm_row'>
					...
					<div className="Select">
						<select name="companySize" value={companySize} onChange={(event) => setCompanySize(event.target.value)} required>
							<option value="">Select an option</option>
