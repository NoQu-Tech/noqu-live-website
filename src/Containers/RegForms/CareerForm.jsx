...
const CareerForm = () => {
  ...
  const handleSubmit = (event) => {
	...
	axios.post('https://app.noqu.in/api/career-form', formData, {
	  headers: {
  ...
  return (
	...
	<div className="CareerForm">
		...
		<div className="reg-form-head">
				<h2>Please furnish the details</h2>			
			</div>
		...
		<div className='CareerForm_row'>
			...
			<div className="Select">
				<select name="currentCTC" value={currentCTC} onChange={(event) => setCurrentCTC(event.target.value)} required>
				<option value="">Select an option</option>
		...
		<div className='CareerForm_row'>
			...
			<div className="Select">
				<select name="noticePeriod" value={noticePeriod} onChange={(event) => setNoticePeriod(event.target.value)} required>
				<option value="">Select an option</option>
		...
		<div className='CareerForm_row'>
			<label>Skillset <span>*</span></label>
			<input 
			type="text" 
			name="skillset" 
			value={skillset} 
		...
		<h5>Attachments</h5>
		<div className='CareerForm_row'>
          <label htmlFor="file">Resume <span>*</span></label>
          <input
            type="file"
            id="resume"
            name="resume"
