...
import organaization from '../../assets/organaization.png'
...
const TAM_form = ({ isOpen, onClose }) => {
	...
	const handleSubmit = (event) => {
		...
		axios.post('https://app.noqu.in/api/tam-form', formData)
			//   axios.post('http://localhost:3004/api/tam-form', formData)
			.then((_response) => {
				navigate('/Submit');
			...
			<div className="SAD_Overlay">
				<div className='SAD'>
					<form onSubmit={handleSubmit} className="SAD_form">
						...
						<div className="SAD_form_inputs">
							<div className='SAD_form_input_row'>
								<label><img src={profile3} alt="" /></label>
								<input
									type="text"
									name="fullName"
									placeholder='Name'
							...
							<div className='SAD_form_Ph_num'>
								<div className='SAD_form_countryCode'>
									<label><img src={call3} alt="" /></label>
									<select
										name="countryCode"
										value={countryCode}
							...
							<div className='SAD_form_input_row'>
								<label><img src={organaization} alt="" /></label>
								<input
									type="text"
							...
							<div className='SAD_form_input_row'>
								...
								<select name="typeOfCall"
									value={typeOfCall}
									onChange={(event) => setTypeOfCall(event.target.value)}
									required>
									<option value="">Select an option</option>
							...
							<div className='SAD_form_input_row'>
								<label><img src={Dateimg} alt="" /></label>
								<input
									type="date"
									name="date"
									value={date}
							...
							<div className='SAD_form_input_row'>
								<label><img src={language3} alt="" /></label>
								<select name="languagePrefered"

									value={languagePrefered}
									onChange={(event) => setLanguagePrefered(event.target.value)}
									required>
									<option value="">Choose your preffered Language</option>
							...
							<div className="SAD_form_button">
								<button type="submit" className='scale-hover' disabled={isSending} >{isSending ? 'Submitting...' : 'Submit'}</button>
							</div>
						</div>
					</form>
				</div>
