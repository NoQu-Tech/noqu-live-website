...
import './ScheduleAdemolp.css';
import LP_instagram from '../../assets/LP_instagram.png'
import LP_facebook from '../../assets/LP_facebook.png'
import LP_twitter from '../../assets/LP_twitter.png'
import { useNavigate } from 'react-router-dom';
import axios from 'axios';
import LP_Submit from '../Submit/LP_Submit';

const ScheduleAdemolp3 = () => {
	useEffect(() => {
		window.scrollTo(0, 0);
	}, []);
	...
	const handleSubmit = (event) => {
		...
		axios.post('https://app.noqu.in/api/youtube-form', formData)
			//   axios.post('http://localhost:3004/api/youtube-form', formData)
			.then((_response) => {
				// navigate('/LP_Submit');
				...
				<div className='schedule-a-demo'>
					<form onSubmit={handleSubmit} id="name-form2">
						...
						<div className='lp_Ph_num'>
							...
							<div className='lp_CC'>
								<select
									...
									disabled={true} // Disable the dropdown to prevent changes
									required>
						...
						<div className="sm_links">
							...
							<a href="https://www.instagram.com/noqu.official?igsh=bXk5ZGp5cHZ5enlj" target='blank'><img src={LP_instagram} alt="" width={40} /></a>						
						</div>
					</form>
				</div>}
		</>
...
export default ScheduleAdemolp3